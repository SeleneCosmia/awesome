...
local color     = require 'themes.chlorine.palette'
local theme     = {}
-- stylua: ignore end

-- Submodule variables
theme.lain_icons = gfs.get_configuration_dir() .. 'modules/lain/icons/layout/zenburn/'
theme.bling_icons = gfs.get_configuration_dir() .. 'modules/bling/icons/layouts/'

-- Default variables
theme.name = 'Chlorine'
theme.useless_gap = dpi(10)
-- theme.font = 'Cartograph CF Thin'
theme.bg_normal = color[1]
theme.bg_focus = color[4]
theme.bg_urgent = color[12]
theme.bg_minimize = color[8]
theme.fg_normal = color[6]
theme.fg_focus = color[1]
theme.fg_urgent = color[1]
theme.fg_minimize = color[7]
-- theme.wallpaper = nil
...
theme.border_color_active = color[11]
theme.border_color_normal = color[9]
-- theme.border_color_urgent = nil
-- theme.border_color_new = nil
theme.border_color_floating_active = color[11]
theme.border_color_floating_normal = color[9]
...
-- hotkeys
theme.hotkeys_bg = color[2]
theme.hotkeys_fg = color[5]
theme.hotkeys_border_width = dpi(3)
theme.hotkeys_border_color = color[10]
-- theme.hotkeys_shape = nil
theme.hotkeys_modifiers_fg = color[7]
theme.hotkeys_label_bg = color[11]
theme.hotkeys_label_fg = color[9]
theme.hotkeys_font = 'GeistMono-NF Light 12'
...
--> bling layouts
theme.layout_centered = theme.bling_icons .. 'centered.png'
theme.layout_deck = theme.bling_icons .. 'deck.png'
theme.layout_equalarea = theme.bling_icons .. 'equalarea.png'
theme.layout_horizontal = theme.bling_icons .. 'horizontal.png'
theme.layout_mstab = theme.bling_icons .. 'mstab.png'
theme.layout_vertical = theme.bling_icons .. 'vertical.png'
--> lain layouts
...
theme.prompt_fg = color[6]
theme.prompt_bg = color[2]
