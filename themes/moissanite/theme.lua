...
-- hotkeys
theme.hotkeys_bg = '#755a0b'
theme.hotkeys_fg = '#fff0a0'
theme.hotkeys_border_width = dpi(3)
theme.hotkeys_border_color = '#ff8b18'
-- theme.hotkeys_shape = nil
theme.hotkeys_modifiers_fg = '#eb5731'
theme.hotkeys_label_bg = '#ab811d'
theme.hotkeys_label_fg = '#463007'
