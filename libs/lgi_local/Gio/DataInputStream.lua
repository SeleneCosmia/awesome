...
---@alias newline_type ("LF"|0)|("CR"|1)|("CR,LF"|2)|("ANY"|3)
...
---@param self lgi.Gio.DataInputStream
---@param newline_type unknown
---@return unknown
function DataInputStream:set_newline_type(newline_type) end

---Gets the current newline type for the stream
---@param self lgi.Gio.DataInputStream
---@return newline_type #The stream's newline type
